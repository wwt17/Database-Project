...
if __name__ == '__main__':
    ...
    argparser.add_argument('--op', choices=['upload', 'train'], default='upload')
    argparser.add_argument('--csv_file', type=Path, default=Path('data.csv'))
    argparser.add_argument('--split_ratio', nargs=3, type=float, default=[3, 1, 1])
    argparser.add_argument('--hidden_dim', type=int, default=512)
    argparser.add_argument('--act', choices=['relu', 'tanh'], default='relu')
    ...
    argparser.add_argument('--max_n_epochs', type=int, default=100)
    argparser.add_argument('--num_workers', type=int, default=16)
    argparser.add_argument('--load_model', type=Path, default=None)
    argparser.add_argument('--save_model', type=Path, default=Path('model.pt'))
    ...
    if args.op == 'upload':
        try:
            ...
            dataframe_to_mysql_table(df[:1000], cursor, csv_file.stem)
